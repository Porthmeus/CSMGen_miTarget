...
topcor <- all.Excors[est_src == "Response" & aim == "intervention",]
...
topcor.sums.plt <- ggplot(topcor.ttests[order(abs(score_absabs_sum),decreasing = T)[1:25],], 
    ...
    labs(x = "Summed importance score", title = "Response associated metabolites") +
    theme_bw() 
topcor.sums.plt
...
topcor.sums.plt <- ggplot(topcor.ttests[order(abs(score_absabs_sum),decreasing = T)[1:25],], 
    ...
    geom_point() +
    geom_vline(linetype = 2, color = "red", xintercept = 0) +
    labs(x = "Mean importance score", title = "Response associated metabolites") +
    theme_bw() 
topcor.sums.plt
